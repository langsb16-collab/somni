var vt=Object.defineProperty;var He=e=>{throw TypeError(e)};var xt=(e,t,r)=>t in e?vt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var g=(e,t,r)=>xt(e,typeof t!="symbol"?t+"":t,r),Ne=(e,t,r)=>t.has(e)||He("Cannot "+r);var d=(e,t,r)=>(Ne(e,t,"read from private field"),r?r.call(e):t.get(e)),m=(e,t,r)=>t.has(e)?He("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),f=(e,t,r,s)=>(Ne(e,t,"write to private field"),s?s.call(e,r):t.set(e,r),r),v=(e,t,r)=>(Ne(e,t,"access private method"),r);var Pe=(e,t,r,s)=>({set _(n){f(e,t,n,r)},get _(){return d(e,t,s)}});var Be=(e,t,r)=>(s,n)=>{let i=-1;return a(0);async function a(l){if(l<=i)throw new Error("next() called multiple times");i=l;let c,o=!1,u;if(e[l]?(u=e[l][0][0],s.req.routeIndex=l):u=l===e.length&&n||void 0,u)try{c=await u(s,()=>a(l+1))}catch(p){if(p instanceof Error&&t)s.error=p,c=await t(p,s),o=!0;else throw p}else s.finalized===!1&&r&&(c=await r(s));return c&&(s.finalized===!1||o)&&(s.res=c),s}},_t=Symbol(),Et=async(e,t=Object.create(null))=>{const{all:r=!1,dot:s=!1}=t,i=(e instanceof st?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?bt(e,{all:r,dot:s}):{}};async function bt(e,t){const r=await e.formData();return r?wt(r,t):{}}function wt(e,t){const r=Object.create(null);return e.forEach((s,n)=>{t.all||n.endsWith("[]")?Rt(r,n,s):r[n]=s}),t.dot&&Object.entries(r).forEach(([s,n])=>{s.includes(".")&&(jt(r,s,n),delete r[s])}),r}var Rt=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},jt=(e,t,r)=>{let s=e;const n=t.split(".");n.forEach((i,a)=>{a===n.length-1?s[i]=r:((!s[i]||typeof s[i]!="object"||Array.isArray(s[i])||s[i]instanceof File)&&(s[i]=Object.create(null)),s=s[i])})},Xe=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},St=e=>{const{groups:t,path:r}=Ot(e),s=Xe(r);return Dt(s,t)},Ot=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,s)=>{const n=`@${s}`;return t.push([n,r]),n}),{groups:t,path:e}},Dt=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[s]=t[r];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,t[r][1]);break}}return e},je={},Tt=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const s=`${e}#${t}`;return je[s]||(r[2]?je[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:je[s]=[e,r[1],!0]),je[s]}return null},Le=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},Ct=e=>Le(e,decodeURI),Ze=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let s=r;for(;s<t.length;s++){const n=t.charCodeAt(s);if(n===37){const i=t.indexOf("?",s),a=t.slice(r,i===-1?void 0:i);return Ct(a.includes("%25")?a.replace(/%25/g,"%2525"):a)}else if(n===63)break}return t.slice(r,s)},qt=e=>{const t=Ze(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},se=(e,t,...r)=>(r.length&&(t=se(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),et=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let s="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){r.length===0&&s===""?r.push("/"):r.push(s);const i=n.replace("?","");s+="/"+i,r.push(s)}else s+="/"+n}),r.filter((n,i,a)=>a.indexOf(n)===i)},Fe=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Le(e,rt):e):e,tt=(e,t,r)=>{let s;if(!r&&t&&!/[%+]/.test(t)){let a=e.indexOf("?",8);if(a===-1)return;for(e.startsWith(t,a+1)||(a=e.indexOf(`&${t}`,a+1));a!==-1;){const l=e.charCodeAt(a+t.length+1);if(l===61){const c=a+t.length+2,o=e.indexOf("&",c);return Fe(e.slice(c,o===-1?void 0:o))}else if(l==38||isNaN(l))return"";a=e.indexOf(`&${t}`,a+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const a=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>a&&a!==-1&&(l=-1);let c=e.slice(i+1,l===-1?a===-1?void 0:a:l);if(s&&(c=Fe(c)),i=a,c==="")continue;let o;l===-1?o="":(o=e.slice(l+1,a===-1?void 0:a),s&&(o=Fe(o))),r?(n[c]&&Array.isArray(n[c])||(n[c]=[]),n[c].push(o)):n[c]??(n[c]=o)}return t?n[t]:n},At=tt,Nt=(e,t)=>tt(e,t,!0),rt=decodeURIComponent,We=e=>Le(e,rt),ae,D,H,nt,it,Ie,W,Ve,st=(Ve=class{constructor(e,t="/",r=[[]]){m(this,H);g(this,"raw");m(this,ae);m(this,D);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});m(this,W,e=>{const{bodyCache:t,raw:r}=this,s=t[e];if(s)return s;const n=Object.keys(t)[0];return n?t[n].then(i=>(n==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,f(this,D,r),f(this,ae,{})}param(e){return e?v(this,H,nt).call(this,e):v(this,H,it).call(this)}query(e){return At(this.url,e)}queries(e){return Nt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,s)=>{t[s]=r}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Et(this,e))}json(){return d(this,W).call(this,"text").then(e=>JSON.parse(e))}text(){return d(this,W).call(this,"text")}arrayBuffer(){return d(this,W).call(this,"arrayBuffer")}blob(){return d(this,W).call(this,"blob")}formData(){return d(this,W).call(this,"formData")}addValidatedData(e,t){d(this,ae)[e]=t}valid(e){return d(this,ae)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[_t](){return d(this,D)}get matchedRoutes(){return d(this,D)[0].map(([[,e]])=>e)}get routePath(){return d(this,D)[0].map(([[,e]])=>e)[this.routeIndex].path}},ae=new WeakMap,D=new WeakMap,H=new WeakSet,nt=function(e){const t=d(this,D)[0][this.routeIndex][1][e],r=v(this,H,Ie).call(this,t);return r&&/\%/.test(r)?We(r):r},it=function(){const e={},t=Object.keys(d(this,D)[0][this.routeIndex][1]);for(const r of t){const s=v(this,H,Ie).call(this,d(this,D)[0][this.routeIndex][1][r]);s!==void 0&&(e[r]=/\%/.test(s)?We(s):s)}return e},Ie=function(e){return d(this,D)[1]?d(this,D)[1][e]:e},W=new WeakMap,Ve),Ft={Stringify:1},at=async(e,t,r,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(n?n[0]+=e:n=[e],Promise.all(i.map(l=>l({phase:t,buffer:n,context:s}))).then(l=>Promise.all(l.filter(Boolean).map(c=>at(c,t,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},kt="text/plain; charset=UTF-8",ke=(e,t)=>({"Content-Type":e,...t}),ye,ve,k,oe,I,O,xe,ce,le,G,_e,Ee,$,ne,ze,It=(ze=class{constructor(e,t){m(this,$);m(this,ye);m(this,ve);g(this,"env",{});m(this,k);g(this,"finalized",!1);g(this,"error");m(this,oe);m(this,I);m(this,O);m(this,xe);m(this,ce);m(this,le);m(this,G);m(this,_e);m(this,Ee);g(this,"render",(...e)=>(d(this,ce)??f(this,ce,t=>this.html(t)),d(this,ce).call(this,...e)));g(this,"setLayout",e=>f(this,xe,e));g(this,"getLayout",()=>d(this,xe));g(this,"setRenderer",e=>{f(this,ce,e)});g(this,"header",(e,t,r)=>{this.finalized&&f(this,O,new Response(d(this,O).body,d(this,O)));const s=d(this,O)?d(this,O).headers:d(this,G)??f(this,G,new Headers);t===void 0?s.delete(e):r!=null&&r.append?s.append(e,t):s.set(e,t)});g(this,"status",e=>{f(this,oe,e)});g(this,"set",(e,t)=>{d(this,k)??f(this,k,new Map),d(this,k).set(e,t)});g(this,"get",e=>d(this,k)?d(this,k).get(e):void 0);g(this,"newResponse",(...e)=>v(this,$,ne).call(this,...e));g(this,"body",(e,t,r)=>v(this,$,ne).call(this,e,t,r));g(this,"text",(e,t,r)=>!d(this,G)&&!d(this,oe)&&!t&&!r&&!this.finalized?new Response(e):v(this,$,ne).call(this,e,t,ke(kt,r)));g(this,"json",(e,t,r)=>v(this,$,ne).call(this,JSON.stringify(e),t,ke("application/json",r)));g(this,"html",(e,t,r)=>{const s=n=>v(this,$,ne).call(this,n,t,ke("text/html; charset=UTF-8",r));return typeof e=="object"?at(e,Ft.Stringify,!1,{}).then(s):s(e)});g(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});g(this,"notFound",()=>(d(this,le)??f(this,le,()=>new Response),d(this,le).call(this,this)));f(this,ye,e),t&&(f(this,I,t.executionCtx),this.env=t.env,f(this,le,t.notFoundHandler),f(this,Ee,t.path),f(this,_e,t.matchResult))}get req(){return d(this,ve)??f(this,ve,new st(d(this,ye),d(this,Ee),d(this,_e))),d(this,ve)}get event(){if(d(this,I)&&"respondWith"in d(this,I))return d(this,I);throw Error("This context has no FetchEvent")}get executionCtx(){if(d(this,I))return d(this,I);throw Error("This context has no ExecutionContext")}get res(){return d(this,O)||f(this,O,new Response(null,{headers:d(this,G)??f(this,G,new Headers)}))}set res(e){if(d(this,O)&&e){e=new Response(e.body,e);for(const[t,r]of d(this,O).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=d(this,O).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(t,r)}f(this,O,e),this.finalized=!0}get var(){return d(this,k)?Object.fromEntries(d(this,k)):{}}},ye=new WeakMap,ve=new WeakMap,k=new WeakMap,oe=new WeakMap,I=new WeakMap,O=new WeakMap,xe=new WeakMap,ce=new WeakMap,le=new WeakMap,G=new WeakMap,_e=new WeakMap,Ee=new WeakMap,$=new WeakSet,ne=function(e,t,r){const s=d(this,O)?new Headers(d(this,O).headers):d(this,G)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[a,l]of i)a.toLowerCase()==="set-cookie"?s.append(a,l):s.set(a,l)}if(r)for(const[i,a]of Object.entries(r))if(typeof a=="string")s.set(i,a);else{s.delete(i);for(const l of a)s.append(i,l)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??d(this,oe);return new Response(e,{status:n,headers:s})},ze),E="ALL",Lt="all",Mt=["get","post","put","delete","options","patch"],ot="Can not add a route since the matcher is already built.",ct=class extends Error{},Ht="__COMPOSED_HANDLER",Pt=e=>e.text("404 Not Found",404),$e=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},T,b,lt,C,J,Se,Oe,de,Bt=(de=class{constructor(t={}){m(this,b);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");m(this,T,"/");g(this,"routes",[]);m(this,C,Pt);g(this,"errorHandler",$e);g(this,"onError",t=>(this.errorHandler=t,this));g(this,"notFound",t=>(f(this,C,t),this));g(this,"fetch",(t,...r)=>v(this,b,Oe).call(this,t,r[1],r[0],t.method));g(this,"request",(t,r,s,n)=>t instanceof Request?this.fetch(r?new Request(t,r):t,s,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${se("/",t)}`,r),s,n)));g(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(v(this,b,Oe).call(this,t.request,t,void 0,t.request.method))})});[...Mt,Lt].forEach(i=>{this[i]=(a,...l)=>(typeof a=="string"?f(this,T,a):v(this,b,J).call(this,i,d(this,T),a),l.forEach(c=>{v(this,b,J).call(this,i,d(this,T),c)}),this)}),this.on=(i,a,...l)=>{for(const c of[a].flat()){f(this,T,c);for(const o of[i].flat())l.map(u=>{v(this,b,J).call(this,o.toUpperCase(),d(this,T),u)})}return this},this.use=(i,...a)=>(typeof i=="string"?f(this,T,i):(f(this,T,"*"),a.unshift(i)),a.forEach(l=>{v(this,b,J).call(this,E,d(this,T),l)}),this);const{strict:s,...n}=t;Object.assign(this,n),this.getPath=s??!0?t.getPath??Ze:qt}route(t,r){const s=this.basePath(t);return r.routes.map(n=>{var a;let i;r.errorHandler===$e?i=n.handler:(i=async(l,c)=>(await Be([],r.errorHandler)(l,()=>n.handler(l,c))).res,i[Ht]=n.handler),v(a=s,b,J).call(a,n.method,n.path,i)}),this}basePath(t){const r=v(this,b,lt).call(this);return r._basePath=se(this._basePath,t),r}mount(t,r,s){let n,i;s&&(typeof s=="function"?i=s:(i=s.optionHandler,s.replaceRequest===!1?n=c=>c:n=s.replaceRequest));const a=i?c=>{const o=i(c);return Array.isArray(o)?o:[o]}:c=>{let o;try{o=c.executionCtx}catch{}return[c.env,o]};n||(n=(()=>{const c=se(this._basePath,t),o=c==="/"?0:c.length;return u=>{const p=new URL(u.url);return p.pathname=p.pathname.slice(o)||"/",new Request(p,u)}})());const l=async(c,o)=>{const u=await r(n(c.req.raw),...a(c));if(u)return u;await o()};return v(this,b,J).call(this,E,se(t,"*"),l),this}},T=new WeakMap,b=new WeakSet,lt=function(){const t=new de({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,f(t,C,d(this,C)),t.routes=this.routes,t},C=new WeakMap,J=function(t,r,s){t=t.toUpperCase(),r=se(this._basePath,r);const n={basePath:this._basePath,path:r,method:t,handler:s};this.router.add(t,r,[s,n]),this.routes.push(n)},Se=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},Oe=function(t,r,s,n){if(n==="HEAD")return(async()=>new Response(null,await v(this,b,Oe).call(this,t,r,s,"GET")))();const i=this.getPath(t,{env:s}),a=this.router.match(n,i),l=new It(t,{path:i,matchResult:a,env:s,executionCtx:r,notFoundHandler:d(this,C)});if(a[0].length===1){let o;try{o=a[0][0][0][0](l,async()=>{l.res=await d(this,C).call(this,l)})}catch(u){return v(this,b,Se).call(this,u,l)}return o instanceof Promise?o.then(u=>u||(l.finalized?l.res:d(this,C).call(this,l))).catch(u=>v(this,b,Se).call(this,u,l)):o??d(this,C).call(this,l)}const c=Be(a[0],this.errorHandler,d(this,C));return(async()=>{try{const o=await c(l);if(!o.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return o.res}catch(o){return v(this,b,Se).call(this,o,l)}})()},de),dt=[];function Wt(e,t){const r=this.buildAllMatchers(),s=((n,i)=>{const a=r[n]||r[E],l=a[2][i];if(l)return l;const c=i.match(a[0]);if(!c)return[[],dt];const o=c.indexOf("",1);return[a[1][o],c]});return this.match=s,s(e,t)}var Te="[^/]+",ge=".*",me="(?:|/.*)",ie=Symbol(),$t=new Set(".\\+*[^]$()");function Ut(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===ge||e===me?1:t===ge||t===me?-1:e===Te?1:t===Te?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Q,X,q,te,Yt=(te=class{constructor(){m(this,Q);m(this,X);m(this,q,Object.create(null))}insert(t,r,s,n,i){if(t.length===0){if(d(this,Q)!==void 0)throw ie;if(i)return;f(this,Q,r);return}const[a,...l]=t,c=a==="*"?l.length===0?["","",ge]:["","",Te]:a==="/*"?["","",me]:a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let o;if(c){const u=c[1];let p=c[2]||Te;if(u&&c[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw ie;if(o=d(this,q)[p],!o){if(Object.keys(d(this,q)).some(y=>y!==ge&&y!==me))throw ie;if(i)return;o=d(this,q)[p]=new te,u!==""&&f(o,X,n.varIndex++)}!i&&u!==""&&s.push([u,d(o,X)])}else if(o=d(this,q)[a],!o){if(Object.keys(d(this,q)).some(u=>u.length>1&&u!==ge&&u!==me))throw ie;if(i)return;o=d(this,q)[a]=new te}o.insert(l,r,s,n,i)}buildRegExpStr(){const r=Object.keys(d(this,q)).sort(Ut).map(s=>{const n=d(this,q)[s];return(typeof d(n,X)=="number"?`(${s})@${d(n,X)}`:$t.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof d(this,Q)=="number"&&r.unshift(`#${d(this,Q)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},Q=new WeakMap,X=new WeakMap,q=new WeakMap,te),Ce,be,Je,Vt=(Je=class{constructor(){m(this,Ce,{varIndex:0});m(this,be,new Yt)}insert(e,t,r){const s=[],n=[];for(let a=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const o=`@\\${a}`;return n[a]=[o,c],a++,l=!0,o}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let a=n.length-1;a>=0;a--){const[l]=n[a];for(let c=i.length-1;c>=0;c--)if(i[c].indexOf(l)!==-1){i[c]=i[c].replace(l,n[a][1]);break}}return d(this,be).insert(i,t,s,d(this,Ce),r),s}buildRegExp(){let e=d(this,be).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,i,a)=>i!==void 0?(r[++t]=Number(i),"$()"):(a!==void 0&&(s[Number(a)]=++t),"")),[new RegExp(`^${e}`),r,s]}},Ce=new WeakMap,be=new WeakMap,Je),zt=[/^$/,[],Object.create(null)],De=Object.create(null);function ut(e){return De[e]??(De[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function Jt(){De=Object.create(null)}function Kt(e){var o;const t=new Vt,r=[];if(e.length===0)return zt;const s=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,p],[y,_])=>u?1:y?-1:p.length-_.length),n=Object.create(null);for(let u=0,p=-1,y=s.length;u<y;u++){const[_,w,A]=s[u];_?n[w]=[A.map(([R])=>[R,Object.create(null)]),dt]:p++;let x;try{x=t.insert(w,p,_)}catch(R){throw R===ie?new ct(w):R}_||(r[p]=A.map(([R,P])=>{const we=Object.create(null);for(P-=1;P>=0;P--){const[Re,N]=x[P];we[Re]=N}return[R,we]}))}const[i,a,l]=t.buildRegExp();for(let u=0,p=r.length;u<p;u++)for(let y=0,_=r[u].length;y<_;y++){const w=(o=r[u][y])==null?void 0:o[1];if(!w)continue;const A=Object.keys(w);for(let x=0,R=A.length;x<R;x++)w[A[x]]=l[w[A[x]]]}const c=[];for(const u in a)c[u]=r[a[u]];return[i,c,n]}function re(e,t){if(e){for(const r of Object.keys(e).sort((s,n)=>n.length-s.length))if(ut(r).test(t))return[...e[r]]}}var U,Y,qe,ht,Ke,Gt=(Ke=class{constructor(){m(this,qe);g(this,"name","RegExpRouter");m(this,U);m(this,Y);g(this,"match",Wt);f(this,U,{[E]:Object.create(null)}),f(this,Y,{[E]:Object.create(null)})}add(e,t,r){var l;const s=d(this,U),n=d(this,Y);if(!s||!n)throw new Error(ot);s[e]||[s,n].forEach(c=>{c[e]=Object.create(null),Object.keys(c[E]).forEach(o=>{c[e][o]=[...c[E][o]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=ut(t);e===E?Object.keys(s).forEach(o=>{var u;(u=s[o])[t]||(u[t]=re(s[o],t)||re(s[E],t)||[])}):(l=s[e])[t]||(l[t]=re(s[e],t)||re(s[E],t)||[]),Object.keys(s).forEach(o=>{(e===E||e===o)&&Object.keys(s[o]).forEach(u=>{c.test(u)&&s[o][u].push([r,i])})}),Object.keys(n).forEach(o=>{(e===E||e===o)&&Object.keys(n[o]).forEach(u=>c.test(u)&&n[o][u].push([r,i]))});return}const a=et(t)||[t];for(let c=0,o=a.length;c<o;c++){const u=a[c];Object.keys(n).forEach(p=>{var y;(e===E||e===p)&&((y=n[p])[u]||(y[u]=[...re(s[p],u)||re(s[E],u)||[]]),n[p][u].push([r,i-o+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(d(this,Y)).concat(Object.keys(d(this,U))).forEach(t=>{e[t]||(e[t]=v(this,qe,ht).call(this,t))}),f(this,U,f(this,Y,void 0)),Jt(),e}},U=new WeakMap,Y=new WeakMap,qe=new WeakSet,ht=function(e){const t=[];let r=e===E;return[d(this,U),d(this,Y)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(i=>[i,s[e][i]]):[];n.length!==0?(r||(r=!0),t.push(...n)):e!==E&&t.push(...Object.keys(s[E]).map(i=>[i,s[E][i]]))}),r?Kt(t):null},Ke),V,L,Ge,Qt=(Ge=class{constructor(e){g(this,"name","SmartRouter");m(this,V,[]);m(this,L,[]);f(this,V,e.routers)}add(e,t,r){if(!d(this,L))throw new Error(ot);d(this,L).push([e,t,r])}match(e,t){if(!d(this,L))throw new Error("Fatal error");const r=d(this,V),s=d(this,L),n=r.length;let i=0,a;for(;i<n;i++){const l=r[i];try{for(let c=0,o=s.length;c<o;c++)l.add(...s[c]);a=l.match(e,t)}catch(c){if(c instanceof ct)continue;throw c}this.match=l.match.bind(l),f(this,V,[l]),f(this,L,void 0);break}if(i===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,a}get activeRouter(){if(d(this,L)||d(this,V).length!==1)throw new Error("No active router has been determined yet.");return d(this,V)[0]}},V=new WeakMap,L=new WeakMap,Ge),fe=Object.create(null),z,S,Z,ue,j,M,K,he,Xt=(he=class{constructor(t,r,s){m(this,M);m(this,z);m(this,S);m(this,Z);m(this,ue,0);m(this,j,fe);if(f(this,S,s||Object.create(null)),f(this,z,[]),t&&r){const n=Object.create(null);n[t]={handler:r,possibleKeys:[],score:0},f(this,z,[n])}f(this,Z,[])}insert(t,r,s){f(this,ue,++Pe(this,ue)._);let n=this;const i=St(r),a=[];for(let l=0,c=i.length;l<c;l++){const o=i[l],u=i[l+1],p=Tt(o,u),y=Array.isArray(p)?p[0]:o;if(y in d(n,S)){n=d(n,S)[y],p&&a.push(p[1]);continue}d(n,S)[y]=new he,p&&(d(n,Z).push(p),a.push(p[1])),n=d(n,S)[y]}return d(n,z).push({[t]:{handler:s,possibleKeys:a.filter((l,c,o)=>o.indexOf(l)===c),score:d(this,ue)}}),n}search(t,r){var c;const s=[];f(this,j,fe);let i=[this];const a=Xe(r),l=[];for(let o=0,u=a.length;o<u;o++){const p=a[o],y=o===u-1,_=[];for(let w=0,A=i.length;w<A;w++){const x=i[w],R=d(x,S)[p];R&&(f(R,j,d(x,j)),y?(d(R,S)["*"]&&s.push(...v(this,M,K).call(this,d(R,S)["*"],t,d(x,j))),s.push(...v(this,M,K).call(this,R,t,d(x,j)))):_.push(R));for(let P=0,we=d(x,Z).length;P<we;P++){const Re=d(x,Z)[P],N=d(x,j)===fe?{}:{...d(x,j)};if(Re==="*"){const B=d(x,S)["*"];B&&(s.push(...v(this,M,K).call(this,B,t,d(x,j))),f(B,j,N),_.push(B));continue}const[mt,Me,pe]=Re;if(!p&&!(pe instanceof RegExp))continue;const F=d(x,S)[mt],yt=a.slice(o).join("/");if(pe instanceof RegExp){const B=pe.exec(yt);if(B){if(N[Me]=B[0],s.push(...v(this,M,K).call(this,F,t,d(x,j),N)),Object.keys(d(F,S)).length){f(F,j,N);const Ae=((c=B[0].match(/\//))==null?void 0:c.length)??0;(l[Ae]||(l[Ae]=[])).push(F)}continue}}(pe===!0||pe.test(p))&&(N[Me]=p,y?(s.push(...v(this,M,K).call(this,F,t,N,d(x,j))),d(F,S)["*"]&&s.push(...v(this,M,K).call(this,d(F,S)["*"],t,N,d(x,j)))):(f(F,j,N),_.push(F)))}}i=_.concat(l.shift()??[])}return s.length>1&&s.sort((o,u)=>o.score-u.score),[s.map(({handler:o,params:u})=>[o,u])]}},z=new WeakMap,S=new WeakMap,Z=new WeakMap,ue=new WeakMap,j=new WeakMap,M=new WeakSet,K=function(t,r,s,n){const i=[];for(let a=0,l=d(t,z).length;a<l;a++){const c=d(t,z)[a],o=c[r]||c[E],u={};if(o!==void 0&&(o.params=Object.create(null),i.push(o),s!==fe||n&&n!==fe))for(let p=0,y=o.possibleKeys.length;p<y;p++){const _=o.possibleKeys[p],w=u[o.score];o.params[_]=n!=null&&n[_]&&!w?n[_]:s[_]??(n==null?void 0:n[_]),u[o.score]=!0}}return i},he),ee,Qe,Zt=(Qe=class{constructor(){g(this,"name","TrieRouter");m(this,ee);f(this,ee,new Xt)}add(e,t,r){const s=et(t);if(s){for(let n=0,i=s.length;n<i;n++)d(this,ee).insert(e,s[n],r);return}d(this,ee).insert(e,t,r)}match(e,t){return d(this,ee).search(e,t)}},ee=new WeakMap,Qe),pt=class extends Bt{constructor(e={}){super(e),this.router=e.router??new Qt({routers:[new Gt,new Zt]})}},er=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(i=>typeof i=="string"?i==="*"?()=>i:a=>i===a?a:null:typeof i=="function"?i:a=>i.includes(a)?a:null)(r.origin),n=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(r.allowMethods);return async function(a,l){var u;function c(p,y){a.res.headers.set(p,y)}const o=await s(a.req.header("origin")||"",a);if(o&&c("Access-Control-Allow-Origin",o),r.credentials&&c("Access-Control-Allow-Credentials","true"),(u=r.exposeHeaders)!=null&&u.length&&c("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),a.req.method==="OPTIONS"){r.origin!=="*"&&c("Vary","Origin"),r.maxAge!=null&&c("Access-Control-Max-Age",r.maxAge.toString());const p=await n(a.req.header("origin")||"",a);p.length&&c("Access-Control-Allow-Methods",p.join(","));let y=r.allowHeaders;if(!(y!=null&&y.length)){const _=a.req.header("Access-Control-Request-Headers");_&&(y=_.split(/\s*,\s*/))}return y!=null&&y.length&&(c("Access-Control-Allow-Headers",y.join(",")),a.res.headers.append("Vary","Access-Control-Request-Headers")),a.res.headers.delete("Content-Length"),a.res.headers.delete("Content-Type"),new Response(null,{headers:a.res.headers,status:204,statusText:"No Content"})}await l(),r.origin!=="*"&&a.header("Vary","Origin",{append:!0})}},tr=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Ue=(e,t=sr)=>{const r=/\.([a-zA-Z0-9]+?)$/,s=e.match(r);if(!s)return;let n=t[s[1]];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},rr={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},sr=rr,nr=(...e)=>{let t=e.filter(n=>n!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const r=t.split("/"),s=[];for(const n of r)n===".."&&s.length>0&&s.at(-1)!==".."?s.pop():n!=="."&&s.push(n);return s.join("/")||"."},ft={br:".br",zstd:".zst",gzip:".gz"},ir=Object.keys(ft),ar="index.html",or=e=>{const t=e.root??"./",r=e.path,s=e.join??nr;return async(n,i)=>{var u,p,y,_;if(n.finalized)return i();let a;if(e.path)a=e.path;else try{if(a=decodeURIComponent(n.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(a))throw new Error}catch{return await((u=e.onNotFound)==null?void 0:u.call(e,n.req.path,n)),i()}let l=s(t,!r&&e.rewriteRequestPath?e.rewriteRequestPath(a):a);e.isDir&&await e.isDir(l)&&(l=s(l,ar));const c=e.getContent;let o=await c(l,n);if(o instanceof Response)return n.newResponse(o.body,o);if(o){const w=e.mimes&&Ue(l,e.mimes)||Ue(l);if(n.header("Content-Type",w||"application/octet-stream"),e.precompressed&&(!w||tr.test(w))){const A=new Set((p=n.req.header("Accept-Encoding"))==null?void 0:p.split(",").map(x=>x.trim()));for(const x of ir){if(!A.has(x))continue;const R=await c(l+ft[x],n);if(R){o=R,n.header("Content-Encoding",x),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((y=e.onFound)==null?void 0:y.call(e,l,n)),n.body(o)}await((_=e.onNotFound)==null?void 0:_.call(e,l,n)),await i()}},cr=async(e,t)=>{let r;t&&t.manifest?typeof t.manifest=="string"?r=JSON.parse(t.manifest):r=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?r=JSON.parse(__STATIC_CONTENT_MANIFEST):r=__STATIC_CONTENT_MANIFEST;let s;t&&t.namespace?s=t.namespace:s=__STATIC_CONTENT;const n=r[e]||e;if(!n)return null;const i=await s.get(n,{type:"stream"});return i||null},lr=e=>async function(r,s){return or({...e,getContent:async i=>cr(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:r.env?r.env.__STATIC_CONTENT:void 0})})(r,s)},dr=e=>lr(e);const h=new pt;h.use("/api/*",er());h.use("/static/*",dr({root:"./"}));h.get("/api/health",e=>e.json({status:"ok",timestamp:new Date().toISOString()}));h.get("/api/questionnaires",async e=>{try{const{DB:t}=e.env,{results:r}=await t.prepare("SELECT * FROM questionnaires").all();return e.json({questionnaires:r})}catch{return e.json({error:"Failed to fetch questionnaires"},500)}});h.get("/api/questionnaires/:type",async e=>{try{const{DB:t}=e.env,r=e.req.param("type"),s=await t.prepare("SELECT * FROM questionnaires WHERE type = ?").bind(r).first();return s?e.json({questionnaire:s}):e.json({error:"Questionnaire not found"},404)}catch{return e.json({error:"Failed to fetch questionnaire"},500)}});h.post("/api/questionnaires/:type/responses",async e=>{try{const{DB:t}=e.env,r=e.req.param("type"),{user_id:s=1,answers:n,score:i,email:a}=await e.req.json(),l=await t.prepare("SELECT * FROM questionnaires WHERE type = ?").bind(r).first();if(!l)return e.json({error:"Questionnaire not found"},404);let c="";r==="ISI"&&(i<=7?c="정상 범위":i<=14?c="경도 불면":i<=21?c="중등도 불면":c="중증 불면 / 전문 상담 권장");const o=await t.prepare(`
